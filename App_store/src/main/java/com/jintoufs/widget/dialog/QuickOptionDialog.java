package com.jintoufs.widget.dialog;
...
public class QuickOptionDialog extends Dialog implements View.OnClickListener {
	...
	private QuickOptionDialog(Context context, int defStyle) {
		...
		contentView.findViewById(R.id.ly_quick_option_voice).setOnClickListener(this);
		contentView.findViewById(R.id.ly_quick_option_scan).setOnClickListener(this);
		contentView.findViewById(R.id.ly_quick_option_note).setOnClickListener(this);
	...
	private void onClickTweetPub(int id) {
		...
		switch (id) {
		case R.id.ly_quick_option_album:
			type = ACTION_TYPE_ALBUM;
			break;
		case R.id.ly_quick_option_photo:
			type = ACTION_TYPE_PHOTO;
			break;
		default:
			break;
		}
        ...
        getOwnerActivity().startActivityForResult(intent, type);
	}
}