...
public class AppConfig {
    ...
    // 默认存放图片的路径
    public final static String DEFAULT_SAVE_IMAGE_PATH = "/storage/sdcard1/hongtai"
            + File.separator + "ht_img" + File.separator;

    // 默认存放文件下载的路径
    public final static String DEFAULT_SAVE_FILE_PATH ="/storage/sdcard1/hongtai"
